...
// Netlist written on Mon Jun 29 23:59:02 2026
//
// Verilog Description of module fuzz
//

module fuzz (clk, out0) /* synthesis syn_module_defined=1 */ ;   // /mnt/2tb/git/awto-2000/fpga/diamond/fuzz/targets/highlevel/pll_basic_defparam/fuzz.v(1[8:12])
    input clk;   // /mnt/2tb/git/awto-2000/fpga/diamond/fuzz/targets/highlevel/pll_basic_defparam/fuzz.v(2[17:20])
    output out0;   // /mnt/2tb/git/awto-2000/fpga/diamond/fuzz/targets/highlevel/pll_basic_defparam/fuzz.v(3[17:21])
    
    wire clk_c /* synthesis is_clock=1 */ ;   // /mnt/2tb/git/awto-2000/fpga/diamond/fuzz/targets/highlevel/pll_basic_defparam/fuzz.v(2[17:20])
    wire clkop_w /* synthesis is_clock=1, SET_AS_NETWORK=clkop_w */ ;   // /mnt/2tb/git/awto-2000/fpga/diamond/fuzz/targets/highlevel/pll_basic_defparam/fuzz.v(7[10:17])
    
    wire GND_net, VCC_net, out0_c, lock_w;
    
    VHI i2 (.Z(VCC_net));
    VLO i1 (.Z(GND_net));
    FD1S3AX out0_5 (.D(lock_w), .CK(clkop_w), .Q(out0_c));   // /mnt/2tb/git/awto-2000/fpga/diamond/fuzz/targets/highlevel/pll_basic_defparam/fuzz.v(24[12:46])
    defparam out0_5.GSR = "ENABLED";
    ...
    IB clk_pad (.I(clk), .O(clk_c));   // /mnt/2tb/git/awto-2000/fpga/diamond/fuzz/targets/highlevel/pll_basic_defparam/fuzz.v(2[17:20])
    TSALL TSALL_INST (.TSALL(GND_net));
    OB out0_pad (.I(out0_c), .O(out0));   // /mnt/2tb/git/awto-2000/fpga/diamond/fuzz/targets/highlevel/pll_basic_defparam/fuzz.v(3[17:21])
