...
module fuzz (clk, out0) /* synthesis syn_module_defined=1 */ ;   // /mnt/2tb/git/awto-2000/fpga/diamond/fuzz/targets/ebr_pdpw8kc_wr9_ww18/fuzz.v(1[8:12])
    input clk;   // /mnt/2tb/git/awto-2000/fpga/diamond/fuzz/targets/ebr_pdpw8kc_wr9_ww18/fuzz.v(2[16:19])
    output out0;   // /mnt/2tb/git/awto-2000/fpga/diamond/fuzz/targets/ebr_pdpw8kc_wr9_ww18/fuzz.v(3[17:21])
    
    wire clk_c /* synthesis is_clock=1 */ ;   // /mnt/2tb/git/awto-2000/fpga/diamond/fuzz/targets/ebr_pdpw8kc_wr9_ww18/fuzz.v(2[16:19])
    
    wire GND_net, out0_c;
    wire [17:0]dout_w;   // /mnt/2tb/git/awto-2000/fpga/diamond/fuzz/targets/ebr_pdpw8kc_wr9_ww18/fuzz.v(7[13:19])
    
    wire out0_N_1, n34, VCC_net, n31, n30, n28, n22, n21;
    
    VHI i16 (.Z(VCC_net));
    LUT4 i10_4_lut (.A(dout_w[1]), .B(dout_w[6]), .C(dout_w[14]), .D(dout_w[11]), 
         .Z(n28)) /* synthesis lut_function=(!(A (B (C (D)+!C !(D))+!B !(C (D)+!C !(D)))+!A !(B (C (D)+!C !(D))+!B !(C (D)+!C !(D))))) */ ;   // /mnt/2tb/git/awto-2000/fpga/diamond/fuzz/targets/ebr_pdpw8kc_wr9_ww18/fuzz.v(25[33:40])
    defparam i10_4_lut.init = 16'h6996;
    OB out0_pad (.I(out0_c), .O(out0));   // /mnt/2tb/git/awto-2000/fpga/diamond/fuzz/targets/ebr_pdpw8kc_wr9_ww18/fuzz.v(3[17:21])
    ...
    LUT4 i13_4_lut (.A(dout_w[17]), .B(dout_w[15]), .C(dout_w[16]), .D(dout_w[4]), 
         .Z(n31)) /* synthesis lut_function=(!(A (B (C (D)+!C !(D))+!B !(C (D)+!C !(D)))+!A !(B (C (D)+!C !(D))+!B !(C (D)+!C !(D))))) */ ;   // /mnt/2tb/git/awto-2000/fpga/diamond/fuzz/targets/ebr_pdpw8kc_wr9_ww18/fuzz.v(25[33:40])
    defparam i13_4_lut.init = 16'h6996;
    LUT4 i4_2_lut (.A(dout_w[7]), .B(dout_w[12]), .Z(n22)) /* synthesis lut_function=(!(A (B)+!A !(B))) */ ;   // /mnt/2tb/git/awto-2000/fpga/diamond/fuzz/targets/ebr_pdpw8kc_wr9_ww18/fuzz.v(25[33:40])
    defparam i4_2_lut.init = 16'h6666;
    LUT4 i12_4_lut (.A(dout_w[3]), .B(dout_w[10]), .C(dout_w[5]), .D(dout_w[0]), 
         .Z(n30)) /* synthesis lut_function=(!(A (B (C (D)+!C !(D))+!B !(C (D)+!C !(D)))+!A !(B (C (D)+!C !(D))+!B !(C (D)+!C !(D))))) */ ;   // /mnt/2tb/git/awto-2000/fpga/diamond/fuzz/targets/ebr_pdpw8kc_wr9_ww18/fuzz.v(25[33:40])
    defparam i12_4_lut.init = 16'h6996;
    LUT4 i16_4_lut (.A(n31), .B(dout_w[9]), .C(n28), .D(dout_w[2]), 
         .Z(n34)) /* synthesis lut_function=(!(A (B (C (D)+!C !(D))+!B !(C (D)+!C !(D)))+!A !(B (C (D)+!C !(D))+!B !(C (D)+!C !(D))))) */ ;   // /mnt/2tb/git/awto-2000/fpga/diamond/fuzz/targets/ebr_pdpw8kc_wr9_ww18/fuzz.v(25[33:40])
    defparam i16_4_lut.init = 16'h6996;
    LUT4 i3_2_lut (.A(dout_w[13]), .B(dout_w[8]), .Z(n21)) /* synthesis lut_function=(!(A (B)+!A !(B))) */ ;   // /mnt/2tb/git/awto-2000/fpga/diamond/fuzz/targets/ebr_pdpw8kc_wr9_ww18/fuzz.v(25[33:40])
    defparam i3_2_lut.init = 16'h6666;
    PUR PUR_INST (.PUR(VCC_net));
    defparam PUR_INST.RST_PULSE = 1;
    LUT4 i17_4_lut (.A(n21), .B(n34), .C(n30), .D(n22), .Z(out0_N_1)) /* synthesis lut_function=(!(A (B (C (D)+!C !(D))+!B !(C (D)+!C !(D)))+!A !(B (C (D)+!C !(D))+!B !(C (D)+!C !(D))))) */ ;   // /mnt/2tb/git/awto-2000/fpga/diamond/fuzz/targets/ebr_pdpw8kc_wr9_ww18/fuzz.v(25[33:40])
    defparam i17_4_lut.init = 16'h6996;
    VLO i1 (.Z(GND_net));
    TSALL TSALL_INST (.TSALL(GND_net));
    IB clk_pad (.I(clk), .O(clk_c));   // /mnt/2tb/git/awto-2000/fpga/diamond/fuzz/targets/ebr_pdpw8kc_wr9_ww18/fuzz.v(2[16:19])
    GSR GSR_INST (.GSR(VCC_net));
    FD1S3AX out0_r_6 (.D(out0_N_1), .CK(clk_c), .Q(out0_c));   // /mnt/2tb/git/awto-2000/fpga/diamond/fuzz/targets/ebr_pdpw8kc_wr9_ww18/fuzz.v(25[8:41])
