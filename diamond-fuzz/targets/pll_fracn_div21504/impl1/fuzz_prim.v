...
module fuzz (clk, out0) /* synthesis syn_module_defined=1 */ ;   // /mnt/2tb/git/awto-2000/fpga/diamond/fuzz/targets/pll_fracn_div21504/fuzz.v(1[8:12])
    input clk;   // /mnt/2tb/git/awto-2000/fpga/diamond/fuzz/targets/pll_fracn_div21504/fuzz.v(2[16:19])
    output out0;   // /mnt/2tb/git/awto-2000/fpga/diamond/fuzz/targets/pll_fracn_div21504/fuzz.v(3[17:21])
    
    wire clk_c /* synthesis is_clock=1 */ ;   // /mnt/2tb/git/awto-2000/fpga/diamond/fuzz/targets/pll_fracn_div21504/fuzz.v(2[16:19])
    wire clkop_w /* synthesis is_clock=1, SET_AS_NETWORK=clkop_w */ ;   // /mnt/2tb/git/awto-2000/fpga/diamond/fuzz/targets/pll_fracn_div21504/fuzz.v(8[6:13])
    
    wire GND_net, VCC_net, out0_c, lock_w;
    
    VHI i2 (.Z(VCC_net));
    OB out0_pad (.I(out0_c), .O(out0));   // /mnt/2tb/git/awto-2000/fpga/diamond/fuzz/targets/pll_fracn_div21504/fuzz.v(3[17:21])
    TSALL TSALL_INST (.TSALL(GND_net));
    IB clk_pad (.I(clk), .O(clk_c));   // /mnt/2tb/git/awto-2000/fpga/diamond/fuzz/targets/pll_fracn_div21504/fuzz.v(2[16:19])
    ...
    FD1S3AX out0_r_5 (.D(lock_w), .CK(clkop_w), .Q(out0_c));   // /mnt/2tb/git/awto-2000/fpga/diamond/fuzz/targets/pll_fracn_div21504/fuzz.v(26[8:44])
