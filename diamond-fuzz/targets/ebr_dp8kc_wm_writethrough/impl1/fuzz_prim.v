...
module fuzz (clk, out0) /* synthesis syn_module_defined=1 */ ;   // /mnt/2tb/git/awto-2000/fpga/diamond/fuzz/targets/ebr_dp8kc_wm_writethrough/fuzz.v(1[8:12])
    input clk;   // /mnt/2tb/git/awto-2000/fpga/diamond/fuzz/targets/ebr_dp8kc_wm_writethrough/fuzz.v(2[16:19])
    output out0;   // /mnt/2tb/git/awto-2000/fpga/diamond/fuzz/targets/ebr_dp8kc_wm_writethrough/fuzz.v(3[17:21])
    
    wire clk_c /* synthesis is_clock=1 */ ;   // /mnt/2tb/git/awto-2000/fpga/diamond/fuzz/targets/ebr_dp8kc_wm_writethrough/fuzz.v(2[16:19])
    
    wire GND_net, out0_c;
    wire [7:0]doa_w;   // /mnt/2tb/git/awto-2000/fpga/diamond/fuzz/targets/ebr_dp8kc_wm_writethrough/fuzz.v(7[12:17])
    
    wire out0_N_1, VCC_net, n14, n10;
    
    VHI i16 (.Z(VCC_net));
    OB out0_pad (.I(out0_c), .O(out0));   // /mnt/2tb/git/awto-2000/fpga/diamond/fuzz/targets/ebr_dp8kc_wm_writethrough/fuzz.v(3[17:21])
    ...
    LUT4 i2_2_lut (.A(doa_w[2]), .B(doa_w[4]), .Z(n10)) /* synthesis lut_function=(!(A (B)+!A !(B))) */ ;   // /mnt/2tb/git/awto-2000/fpga/diamond/fuzz/targets/ebr_dp8kc_wm_writethrough/fuzz.v(32[33:39])
    defparam i2_2_lut.init = 16'h6666;
    LUT4 i7_4_lut (.A(doa_w[0]), .B(n14), .C(n10), .D(doa_w[6]), .Z(out0_N_1)) /* synthesis lut_function=(!(A (B (C (D)+!C !(D))+!B !(C (D)+!C !(D)))+!A !(B (C (D)+!C !(D))+!B !(C (D)+!C !(D))))) */ ;   // /mnt/2tb/git/awto-2000/fpga/diamond/fuzz/targets/ebr_dp8kc_wm_writethrough/fuzz.v(32[33:39])
    ...
    LUT4 i6_4_lut (.A(doa_w[3]), .B(doa_w[1]), .C(doa_w[5]), .D(doa_w[7]), 
         .Z(n14)) /* synthesis lut_function=(!(A (B (C (D)+!C !(D))+!B !(C (D)+!C !(D)))+!A !(B (C (D)+!C !(D))+!B !(C (D)+!C !(D))))) */ ;   // /mnt/2tb/git/awto-2000/fpga/diamond/fuzz/targets/ebr_dp8kc_wm_writethrough/fuzz.v(32[33:39])
    defparam i6_4_lut.init = 16'h6996;
    IB clk_pad (.I(clk), .O(clk_c));   // /mnt/2tb/git/awto-2000/fpga/diamond/fuzz/targets/ebr_dp8kc_wm_writethrough/fuzz.v(2[16:19])
    GSR GSR_INST (.GSR(VCC_net));
    FD1S3AX out0_r_6 (.D(out0_N_1), .CK(clk_c), .Q(out0_c));   // /mnt/2tb/git/awto-2000/fpga/diamond/fuzz/targets/ebr_dp8kc_wm_writethrough/fuzz.v(32[8:40])
