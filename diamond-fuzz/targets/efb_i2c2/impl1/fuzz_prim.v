...
// Netlist written on Mon Jun 29 23:24:51 2026
//
// Verilog Description of module fuzz
//

module fuzz (clk, i2c2_scl, i2c2_sda, out0) /* synthesis syn_module_defined=1 */ ;   // /mnt/2tb/git/awto-2000/fpga/diamond/fuzz/targets/efb_i2c2/fuzz.v(1[8:12])
    input clk;   // /mnt/2tb/git/awto-2000/fpga/diamond/fuzz/targets/efb_i2c2/fuzz.v(2[16:19])
    input i2c2_scl;   // /mnt/2tb/git/awto-2000/fpga/diamond/fuzz/targets/efb_i2c2/fuzz.v(3[16:24])
    input i2c2_sda;   // /mnt/2tb/git/awto-2000/fpga/diamond/fuzz/targets/efb_i2c2/fuzz.v(3[26:34])
    output out0;   // /mnt/2tb/git/awto-2000/fpga/diamond/fuzz/targets/efb_i2c2/fuzz.v(4[17:21])
    
    wire clk_c /* synthesis is_clock=1, SET_AS_NETWORK=clk_c */ ;   // /mnt/2tb/git/awto-2000/fpga/diamond/fuzz/targets/efb_i2c2/fuzz.v(2[16:19])
    wire i2c2_scl_c /* synthesis is_clock=1 */ ;   // /mnt/2tb/git/awto-2000/fpga/diamond/fuzz/targets/efb_i2c2/fuzz.v(3[16:24])
    
    wire GND_net, i2c2_sda_c, out0_c, wbacko_w;
    wire [7:0]wbdato_w;   // /mnt/2tb/git/awto-2000/fpga/diamond/fuzz/targets/efb_i2c2/fuzz.v(9[12:20])
    
    wire out0_N_1, n15, VCC_net, n14;
    
    VHI i17 (.Z(VCC_net));
    LUT4 i6_4_lut (.A(wbdato_w[1]), .B(wbdato_w[7]), .C(wbdato_w[2]), 
         .D(wbdato_w[3]), .Z(n15)) /* synthesis lut_function=(!(A (B (C (D)+!C !(D))+!B !(C (D)+!C !(D)))+!A !(B (C (D)+!C !(D))+!B !(C (D)+!C !(D))))) */ ;   // /mnt/2tb/git/awto-2000/fpga/diamond/fuzz/targets/efb_i2c2/fuzz.v(45[33:53])
    defparam i6_4_lut.init = 16'h6996;
    OB out0_pad (.I(out0_c), .O(out0));   // /mnt/2tb/git/awto-2000/fpga/diamond/fuzz/targets/efb_i2c2/fuzz.v(4[17:21])
    ...
    LUT4 i8_4_lut (.A(n15), .B(wbdato_w[6]), .C(n14), .D(wbacko_w), 
         .Z(out0_N_1)) /* synthesis lut_function=(!(A (B (C (D)+!C !(D))+!B !(C (D)+!C !(D)))+!A !(B (C (D)+!C !(D))+!B !(C (D)+!C !(D))))) */ ;   // /mnt/2tb/git/awto-2000/fpga/diamond/fuzz/targets/efb_i2c2/fuzz.v(45[33:53])
    ...
    LUT4 i5_3_lut (.A(wbdato_w[0]), .B(wbdato_w[4]), .C(wbdato_w[5]), 
         .Z(n14)) /* synthesis lut_function=(A (B (C)+!B !(C))+!A !(B (C)+!B !(C))) */ ;   // /mnt/2tb/git/awto-2000/fpga/diamond/fuzz/targets/efb_i2c2/fuzz.v(45[33:53])
    defparam i5_3_lut.init = 16'h9696;
    IB clk_pad (.I(clk), .O(clk_c));   // /mnt/2tb/git/awto-2000/fpga/diamond/fuzz/targets/efb_i2c2/fuzz.v(2[16:19])
    IB i2c2_scl_pad (.I(i2c2_scl), .O(i2c2_scl_c));   // /mnt/2tb/git/awto-2000/fpga/diamond/fuzz/targets/efb_i2c2/fuzz.v(3[16:24])
    IB i2c2_sda_pad (.I(i2c2_sda), .O(i2c2_sda_c));   // /mnt/2tb/git/awto-2000/fpga/diamond/fuzz/targets/efb_i2c2/fuzz.v(3[26:34])
    GSR GSR_INST (.GSR(VCC_net));
    FD1S3AX out0_r_7 (.D(out0_N_1), .CK(clk_c), .Q(out0_c));   // /mnt/2tb/git/awto-2000/fpga/diamond/fuzz/targets/efb_i2c2/fuzz.v(45[8:54])
