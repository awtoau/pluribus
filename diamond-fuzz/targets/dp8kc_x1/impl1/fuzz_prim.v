...
// Netlist written on Mon Jun 29 23:03:45 2026
//
// Verilog Description of module fuzz
//

module fuzz (clk, out0) /* synthesis syn_module_defined=1 */ ;   // /mnt/2tb/git/awto-2000/fpga/diamond/fuzz/targets/dp8kc_x1/fuzz.v(1[8:12])
    input clk;   // /mnt/2tb/git/awto-2000/fpga/diamond/fuzz/targets/dp8kc_x1/fuzz.v(2[16:19])
    output out0;   // /mnt/2tb/git/awto-2000/fpga/diamond/fuzz/targets/dp8kc_x1/fuzz.v(3[17:21])
    
    wire clk_c /* synthesis is_clock=1 */ ;   // /mnt/2tb/git/awto-2000/fpga/diamond/fuzz/targets/dp8kc_x1/fuzz.v(2[16:19])
    
    wire GND_net, out0_c;
    wire [0:0]doa_w;   // /mnt/2tb/git/awto-2000/fpga/diamond/fuzz/targets/dp8kc_x1/fuzz.v(7[12:17])
    
    wire VCC_net;
    
    VHI i14 (.Z(VCC_net));
    OB out0_pad (.I(out0_c), .O(out0));   // /mnt/2tb/git/awto-2000/fpga/diamond/fuzz/targets/dp8kc_x1/fuzz.v(3[17:21])
    ...
    DP8KC u0 (.DIA0(GND_net), .DIA1(GND_net), .DIA2(GND_net), .DIA3(GND_net), 
          ...
          .DOA0(doa_w[0])) /* synthesis syn_instantiated=1 */ ;
    defparam u0.DATA_WIDTH_A = 1;
    defparam u0.DATA_WIDTH_B = 1;
    ...
    IB clk_pad (.I(clk), .O(clk_c));   // /mnt/2tb/git/awto-2000/fpga/diamond/fuzz/targets/dp8kc_x1/fuzz.v(2[16:19])
    GSR GSR_INST (.GSR(VCC_net));
    FD1S3AX out0_r_5 (.D(doa_w[0]), .CK(clk_c), .Q(out0_c));   // /mnt/2tb/git/awto-2000/fpga/diamond/fuzz/targets/dp8kc_x1/fuzz.v(33[8:40])
