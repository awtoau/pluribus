...
module fuzz (clk, out0) /* synthesis syn_module_defined=1 */ ;   // /mnt/2tb/git/awto-2000/fpga/diamond/fuzz/targets/pdpw8kc_x18/fuzz.v(1[8:12])
    input clk;   // /mnt/2tb/git/awto-2000/fpga/diamond/fuzz/targets/pdpw8kc_x18/fuzz.v(2[16:19])
    output out0;   // /mnt/2tb/git/awto-2000/fpga/diamond/fuzz/targets/pdpw8kc_x18/fuzz.v(3[17:21])
    
    wire clk_c /* synthesis is_clock=1 */ ;   // /mnt/2tb/git/awto-2000/fpga/diamond/fuzz/targets/pdpw8kc_x18/fuzz.v(2[16:19])
    
    wire GND_net, out0_c;
    wire [17:0]do_w;   // /mnt/2tb/git/awto-2000/fpga/diamond/fuzz/targets/pdpw8kc_x18/fuzz.v(7[13:17])
    
    wire out0_N_1, n34, VCC_net, n31, n30, n28, n22, n21;
    
    VHI i16 (.Z(VCC_net));
    LUT4 i10_4_lut (.A(do_w[1]), .B(do_w[6]), .C(do_w[14]), .D(do_w[11]), 
         .Z(n28)) /* synthesis lut_function=(!(A (B (C (D)+!C !(D))+!B !(C (D)+!C !(D)))+!A !(B (C (D)+!C !(D))+!B !(C (D)+!C !(D))))) */ ;   // /mnt/2tb/git/awto-2000/fpga/diamond/fuzz/targets/pdpw8kc_x18/fuzz.v(30[33:38])
    defparam i10_4_lut.init = 16'h6996;
    OB out0_pad (.I(out0_c), .O(out0));   // /mnt/2tb/git/awto-2000/fpga/diamond/fuzz/targets/pdpw8kc_x18/fuzz.v(3[17:21])
    PDPW8KC u0 (.DI0(GND_net), .DI1(GND_net), .DI2(GND_net), .DI3(GND_net), 
            ...
            .CSR2(GND_net), .RST(GND_net), .DO0(do_w[0]), .DO1(do_w[1]), 
            .DO2(do_w[2]), .DO3(do_w[3]), .DO4(do_w[4]), .DO5(do_w[5]), 
            .DO6(do_w[6]), .DO7(do_w[7]), .DO8(do_w[8]), .DO9(do_w[9]), 
            .DO10(do_w[10]), .DO11(do_w[11]), .DO12(do_w[12]), .DO13(do_w[13]), 
            .DO14(do_w[14]), .DO15(do_w[15]), .DO16(do_w[16]), .DO17(do_w[17])) /* synthesis syn_instantiated=1 */ ;
    ...
    LUT4 i13_4_lut (.A(do_w[17]), .B(do_w[15]), .C(do_w[16]), .D(do_w[4]), 
         .Z(n31)) /* synthesis lut_function=(!(A (B (C (D)+!C !(D))+!B !(C (D)+!C !(D)))+!A !(B (C (D)+!C !(D))+!B !(C (D)+!C !(D))))) */ ;   // /mnt/2tb/git/awto-2000/fpga/diamond/fuzz/targets/pdpw8kc_x18/fuzz.v(30[33:38])
    defparam i13_4_lut.init = 16'h6996;
    LUT4 i4_2_lut (.A(do_w[7]), .B(do_w[12]), .Z(n22)) /* synthesis lut_function=(!(A (B)+!A !(B))) */ ;   // /mnt/2tb/git/awto-2000/fpga/diamond/fuzz/targets/pdpw8kc_x18/fuzz.v(30[33:38])
    defparam i4_2_lut.init = 16'h6666;
    LUT4 i12_4_lut (.A(do_w[3]), .B(do_w[10]), .C(do_w[5]), .D(do_w[0]), 
         .Z(n30)) /* synthesis lut_function=(!(A (B (C (D)+!C !(D))+!B !(C (D)+!C !(D)))+!A !(B (C (D)+!C !(D))+!B !(C (D)+!C !(D))))) */ ;   // /mnt/2tb/git/awto-2000/fpga/diamond/fuzz/targets/pdpw8kc_x18/fuzz.v(30[33:38])
    defparam i12_4_lut.init = 16'h6996;
    LUT4 i16_4_lut (.A(n31), .B(do_w[9]), .C(n28), .D(do_w[2]), .Z(n34)) /* synthesis lut_function=(!(A (B (C (D)+!C !(D))+!B !(C (D)+!C !(D)))+!A !(B (C (D)+!C !(D))+!B !(C (D)+!C !(D))))) */ ;   // /mnt/2tb/git/awto-2000/fpga/diamond/fuzz/targets/pdpw8kc_x18/fuzz.v(30[33:38])
    defparam i16_4_lut.init = 16'h6996;
    LUT4 i3_2_lut (.A(do_w[13]), .B(do_w[8]), .Z(n21)) /* synthesis lut_function=(!(A (B)+!A !(B))) */ ;   // /mnt/2tb/git/awto-2000/fpga/diamond/fuzz/targets/pdpw8kc_x18/fuzz.v(30[33:38])
    defparam i3_2_lut.init = 16'h6666;
    PUR PUR_INST (.PUR(VCC_net));
    defparam PUR_INST.RST_PULSE = 1;
    LUT4 i17_4_lut (.A(n21), .B(n34), .C(n30), .D(n22), .Z(out0_N_1)) /* synthesis lut_function=(!(A (B (C (D)+!C !(D))+!B !(C (D)+!C !(D)))+!A !(B (C (D)+!C !(D))+!B !(C (D)+!C !(D))))) */ ;   // /mnt/2tb/git/awto-2000/fpga/diamond/fuzz/targets/pdpw8kc_x18/fuzz.v(30[33:38])
    defparam i17_4_lut.init = 16'h6996;
    VLO i1 (.Z(GND_net));
    TSALL TSALL_INST (.TSALL(GND_net));
    IB clk_pad (.I(clk), .O(clk_c));   // /mnt/2tb/git/awto-2000/fpga/diamond/fuzz/targets/pdpw8kc_x18/fuzz.v(2[16:19])
    GSR GSR_INST (.GSR(VCC_net));
    FD1S3AX out0_r_6 (.D(out0_N_1), .CK(clk_c), .Q(out0_c));   // /mnt/2tb/git/awto-2000/fpga/diamond/fuzz/targets/pdpw8kc_x18/fuzz.v(30[8:39])
