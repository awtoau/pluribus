...
// Netlist written on Mon Jun 29 23:03:50 2026
//
// Verilog Description of module fuzz
//

module fuzz (clk, out0) /* synthesis syn_module_defined=1 */ ;   // /mnt/2tb/git/awto-2000/fpga/diamond/fuzz/targets/dp8kc_x2/fuzz.v(1[8:12])
    input clk;   // /mnt/2tb/git/awto-2000/fpga/diamond/fuzz/targets/dp8kc_x2/fuzz.v(2[16:19])
    output out0;   // /mnt/2tb/git/awto-2000/fpga/diamond/fuzz/targets/dp8kc_x2/fuzz.v(3[17:21])
    
    wire clk_c /* synthesis is_clock=1 */ ;   // /mnt/2tb/git/awto-2000/fpga/diamond/fuzz/targets/dp8kc_x2/fuzz.v(2[16:19])
    
    wire GND_net, out0_c;
    wire [1:0]doa_w;   // /mnt/2tb/git/awto-2000/fpga/diamond/fuzz/targets/dp8kc_x2/fuzz.v(7[12:17])
    
    wire out0_N_1, VCC_net;
    
    VHI i15 (.Z(VCC_net));
    TSALL TSALL_INST (.TSALL(GND_net));
    OB out0_pad (.I(out0_c), .O(out0));   // /mnt/2tb/git/awto-2000/fpga/diamond/fuzz/targets/dp8kc_x2/fuzz.v(3[17:21])
    DP8KC u0 (.DIA0(GND_net), .DIA1(GND_net), .DIA2(GND_net), .DIA3(GND_net), 
          ...
          .DOA0(doa_w[0]), .DOA1(doa_w[1])) /* synthesis syn_instantiated=1 */ ;
    defparam u0.DATA_WIDTH_A = 2;
    defparam u0.DATA_WIDTH_B = 2;
    ...
    IB clk_pad (.I(clk), .O(clk_c));   // /mnt/2tb/git/awto-2000/fpga/diamond/fuzz/targets/dp8kc_x2/fuzz.v(2[16:19])
    GSR GSR_INST (.GSR(VCC_net));
    FD1S3AX out0_r_6 (.D(out0_N_1), .CK(clk_c), .Q(out0_c));   // /mnt/2tb/git/awto-2000/fpga/diamond/fuzz/targets/dp8kc_x2/fuzz.v(33[8:40])
    defparam out0_r_6.GSR = "ENABLED";
    PUR PUR_INST (.PUR(VCC_net));
    defparam PUR_INST.RST_PULSE = 1;
    VLO i1 (.Z(GND_net));
    LUT4 doa_w_1__I_0_i1_2_lut (.A(doa_w[0]), .B(doa_w[1]), .Z(out0_N_1)) /* synthesis lut_function=(!(A (B)+!A !(B))) */ ;   // /mnt/2tb/git/awto-2000/fpga/diamond/fuzz/targets/dp8kc_x2/fuzz.v(33[33:39])
    defparam doa_w_1__I_0_i1_2_lut.init = 16'h6666;
