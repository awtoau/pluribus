...
// Netlist written on Mon Jun 29 23:53:32 2026
//
// Verilog Description of module fuzz
//

module fuzz (clk, out0) /* synthesis syn_module_defined=1 */ ;   // /mnt/2tb/git/awto-2000/fpga/diamond/fuzz/targets/ehxpllj_4out/fuzz.v(1[8:12])
    input clk;   // /mnt/2tb/git/awto-2000/fpga/diamond/fuzz/targets/ehxpllj_4out/fuzz.v(2[16:19])
    output out0;   // /mnt/2tb/git/awto-2000/fpga/diamond/fuzz/targets/ehxpllj_4out/fuzz.v(3[17:21])
    
    wire clk_c /* synthesis is_clock=1 */ ;   // /mnt/2tb/git/awto-2000/fpga/diamond/fuzz/targets/ehxpllj_4out/fuzz.v(2[16:19])
    wire clkop_w /* synthesis is_clock=1, SET_AS_NETWORK=clkop_w */ ;   // /mnt/2tb/git/awto-2000/fpga/diamond/fuzz/targets/ehxpllj_4out/fuzz.v(8[6:13])
    wire clkos_w /* synthesis is_clock=1 */ ;   // /mnt/2tb/git/awto-2000/fpga/diamond/fuzz/targets/ehxpllj_4out/fuzz.v(9[6:13])
    wire clkos2_w /* synthesis is_clock=1 */ ;   // /mnt/2tb/git/awto-2000/fpga/diamond/fuzz/targets/ehxpllj_4out/fuzz.v(9[15:23])
    wire clkos3_w /* synthesis is_clock=1 */ ;   // /mnt/2tb/git/awto-2000/fpga/diamond/fuzz/targets/ehxpllj_4out/fuzz.v(9[25:33])
    
    wire GND_net, VCC_net, out0_c, lock_w, out0_N_1;
    
    VHI i2 (.Z(VCC_net));
    PUR PUR_INST (.PUR(VCC_net));
    defparam PUR_INST.RST_PULSE = 1;
    TSALL TSALL_INST (.TSALL(GND_net));
    LUT4 i3_4_lut (.A(lock_w), .B(clkos3_w), .C(clkos2_w), .D(clkos_w), 
         .Z(out0_N_1)) /* synthesis lut_function=(!(A (B (C (D)+!C !(D))+!B !(C (D)+!C !(D)))+!A !(B (C (D)+!C !(D))+!B !(C (D)+!C !(D))))) */ ;   // /mnt/2tb/git/awto-2000/fpga/diamond/fuzz/targets/ehxpllj_4out/fuzz.v(57[37:75])
    defparam i3_4_lut.init = 16'h6996;
    EHXPLLJ u0 (.CLKI(clk_c), .CLKFB(clkop_w), .PHASESEL0(GND_net), .PHASESEL1(GND_net), 
            ...
            .CLKOP(clkop_w), .CLKOS(clkos_w), .CLKOS2(clkos2_w), .CLKOS3(clkos3_w), 
            .LOCK(lock_w)) /* synthesis syn_instantiated=1 */ ;
    defparam u0.CLKI_DIV = 1;
    defparam u0.CLKFB_DIV = 1;
    defparam u0.CLKOP_DIV = 1;
    defparam u0.CLKOS_DIV = 4;
    defparam u0.CLKOS2_DIV = 2;
    defparam u0.CLKOS3_DIV = 16;
    ...
    defparam u0.FRACN_ENABLE = "DISABLED";
    defparam u0.FRACN_DIV = 0;
    ...
    FD1S3AX out0_r_8 (.D(out0_N_1), .CK(clkop_w), .Q(out0_c));   // /mnt/2tb/git/awto-2000/fpga/diamond/fuzz/targets/ehxpllj_4out/fuzz.v(57[8:76])
    defparam out0_r_8.GSR = "ENABLED";
    VLO i1 (.Z(GND_net));
    IB clk_pad (.I(clk), .O(clk_c));   // /mnt/2tb/git/awto-2000/fpga/diamond/fuzz/targets/ehxpllj_4out/fuzz.v(2[16:19])
    GSR GSR_INST (.GSR(VCC_net));
    OB out0_pad (.I(out0_c), .O(out0));   // /mnt/2tb/git/awto-2000/fpga/diamond/fuzz/targets/ehxpllj_4out/fuzz.v(3[17:21])
